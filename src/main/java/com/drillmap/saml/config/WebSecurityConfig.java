package com.drillmap.saml.config;
...
import com.drillmap.saml.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public HTTPMetadataProvider metadataProvider()
        ...
        HTTPMetadataProvider provider =
                new HTTPMetadataProvider(metadataURL, 5000);
        provider.setParserPool(parserPool());
        return provider;
    }
    
    @Bean
    public HTTPMetadataProvider metadataProvider_original()
            throws MetadataProviderException {
        String metadataURL = "http://idp.ssocircle.com/idp-meta.xml";
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("urn:drillmap:galaxy:austin");
